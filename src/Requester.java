...
public class Requester implements MessageListener {
     ...
     * Calls method createChannel with initialized parameters.
     */
    ...
    public String getInput() {
        ...
        return "b"; // returns Request (location) unless there is an input error.
    }
    ...
    public void messageReceived(String message, int channelID) {
        ...
        System.out.println("Volunteer " + message + " assigned and will arrive shortly.");
        runner();
    }
    ...
    public void createChannel() {
        chan.setMessageListener(this); //starts thread to listen for message back from server
    ...
    public static void main(String[] args) { // args[] is the line after Java Volunteers host port
        try {
